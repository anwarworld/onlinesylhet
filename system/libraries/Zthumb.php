...
//private functions
    ...
    function getImageResource() {
        $this->getImageInfo();
        switch ($this->_otype) {
            case '1':/* GIF */$this->_source = imagecreatefromgif($this->_sourcepath . $this->_filename);
                break;
            case '3':/* PNG */$this->_source = imagecreatefrompng($this->_sourcepath . $this->_filename);
                break;
            case '6':/* WBMP */$this->_source = imagecreatefromwbmp($this->_sourcepath . $this->_filename);
                break;
    ...
    function writeFile() {
        ...
        switch ($this->_otype) {
            case '1':/* GIF */imagegif($this->_thumb, $this->_thumbpath . $this->_outputfilename);
                break;
            case '3':/* PNG */imagepng($this->_thumb, $this->_thumbpath . $this->_outputfilename);
                break;
            case '6':/* BMP */imagewbmp($this->_thumb, $this->_thumbpath . $this->_outputfilename);
                break;
